...
//   passwordAlertMessage: string | null = null; // Messaggio di alert per la password
//   usernameAlertMessage: string | null = null; // Messaggio di alert per il nome utente
...
//             this.newPassword = '';
//             this.confirmPassword = '';
//             setTimeout(() => this.successMessage = null, 5000); // Il messaggio scompare dopo 3 secondi
//           },
//           (error) => {
//             console.error(this.translate.instant('profile.PASSWORD_ERROR'), error);
//             this.showErrorPopover(this.translate.instant('profile.PASSWORD_ERROR'));
...
//           (updatedUser) => {
//             this.authSrv.updateUser(updatedUser);
//             this.usernameAlertMessage = this.translate.instant('profile.USERNAME_UPDATED_SUCCESS');
//             setTimeout(() => this.usernameAlertMessage = null, 3000); // Il messaggio scompare dopo 5 secondi
//                     },
//           (error) => {
//             console.error(this.translate.instant('profile.UPDATE_ERROR'), error);
//           }
